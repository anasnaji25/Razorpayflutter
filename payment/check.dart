import 'dart:ffi';
import 'package:BusinessTracker/screens/profilecreation.dart';
import 'package:BusinessTracker/screens/subscription/subscription.dart';
import 'package:BusinessTracker/database/database.dart';
...
import 'package:BusinessTracker/screens/widgets/signUpProfile.dart';
...
class _CheckRazorState extends State<CheckRazor> {
  ...
  _addTodb() async {
    await DatabaseH.instance
        .insertsubscription({DatabaseH.subscriptionDate: selectedPlan});
  }
